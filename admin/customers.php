        ...
        <div class="col-lg-10 col-12 p-3">
            ...
            <div class="card">
              ...
              <table class="table table-striped table-hover table-bordered text-center">
                ...
                <tbody>
                    <?php 
                    $query_loans = mysqli_query($conn, "SELECT * FROM users WHERE LEVEL=2");
                 
                      if (isset($_POST['showBtn'])) {
                            $show = $_POST['show'];

                          $query_loans = mysqli_query($conn, "SELECT * FROM users LIMIT $show ");
                           
                      }

                      if (isset($_POST['searchBtn'])) {
                            $search = $_POST['search'];
                            $query_loans = mysqli_query($conn, "SELECT * FROM users WHERE FNAME LIKE '%$search%' OR LNAME LIKE '%$search%' OR USER_ID LIKE '%$search%' ");
                        ...
                        while ($data = mysqli_fetch_assoc($query_loans)) {
                            ...
                            // if ($data['LEVEL'] == 2) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="view_borrowers.php?ID=<?= $data['USER_ID'] ?>" class="btn btn-primary">View</a></td>
                                </tr>
                            <?php
                            // }
